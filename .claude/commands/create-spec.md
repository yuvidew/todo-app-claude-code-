...
Spendly Todo App. Always follow the rules in CLAUDE.md.
...
- `login/route.ts`, `signup/route.ts` etc — existing routes and structure
- `prisma/schema.prisma` — existing schema and functions
...
Always verify against `prisma/schema.prisma` before writing this.
